...
# Body parameters: cron_expression, performance, name, query_id, is_private
...
# Uses correct Dune API field names per docs:
...
RESPONSE=$(curl -s -X POST \
    ...
    -d "$(jq -n \
        ...
        '{name: $name, query_id: $query_id, cron_expression: $cron_expression, performance: $performance}')" \
